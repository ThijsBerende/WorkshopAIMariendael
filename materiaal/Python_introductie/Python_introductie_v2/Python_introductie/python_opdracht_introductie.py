...
door een woord te typen kun je een variable aanmaken. Aan deze variable kun je een waarde koppelen.
stel we willen zeggen, mijn leeftijd is 20 jaar.
"""
leeftijd = 20
"""
hierboven zie je nu dat mijn leeftijd is gekoppeld aan het getal 20. we kunnen dit testen door de print()
functie te gebruiken.
"""
print(leeftijd)
"""
Als je rechts boven op het groene driehoekje drukt zal je het bestand 'runnen' of aanzetten.
De computer gaat de code regel voor regel af. Ook zul je 20 zien staan in de terminal. Dit is de leeftijd
die we printen hierboven. Je kunt dus variables aanroepen, en je krijgt terug wat je eraan gekoppeld hebt.
"""

def strings():
    """
    Stel we willen nu een naam koppelen aan een variable, dus een letterlijk woord in plaats van een getal.
    Dit kun je doen met een string. Een string is eigenlijk een woord met aanhalingstekens eromheen.
    """
    naam = "Jasper"
    """
...
def waar_of_niet_waar():
    ...
    # Haal de Hasttags weg voor de prints
    #print(a , b == False)
    #print(a, b == True)
    #print(, a == False)
